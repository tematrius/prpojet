...
<div class="container mt-4">
  <h3 class="mb-4"><i class="bi bi-send"></i> Envoyer un ou plusieurs documents au secrétariat</h3>
  ...
  <form action="envoyer.php" class="dropzone" id="uploadDropzone" enctype="multipart/form-data">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['file'])) {
  ...
  $stmt = $pdo->prepare("INSERT INTO documents (titre, nom_fichier, chemin, commentaire, provenance, etat, date_upload, auteur_id) VALUES (?, ?, ?, ?, 'employe', 'en_attente', NOW(), ?)");
